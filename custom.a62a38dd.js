...
},{"process":"g5I+"}],"SoV9":[function(require,module,exports) {
/**
 * Owl Carousel v2.3.4
...
},{"./build/js/intlTelInput":"DuRD"}],"B0gP":[function(require,module,exports) {
...
},{}],"8hAk":[function(require,module,exports) {
var define;
var global = arguments[3];
(function (global, factory) {
	if (typeof define === "function" && define.amd) {
...
var intlTelInputUtils = require("../node_modules/intl-tel-input/build/js/utils.js");

var jqueryDatepicker = require("jquery-datepicker"); //placeholder input для ввода номера телефона


function telInput() {
  document.querySelectorAll(".intl-tel-input").forEach(function (el) {
    intlTelInput(el, {
      defaultCountry: "ru",
...
telInput(); //JDataPicket

function datePicker() {
  jqueryDatepicker($); //default settings datePicker
  ...
  $("#datepicker2").datepicker(settings);
  $("#date").datepicker(settings);
}

;
datePicker(); // скрыть/показать текст в input[type=password]

$(function () {
  btn = $(".freebook__form-eyesBtn");

  for (i = 0; i < btn.length; i++) {
    btn[i].addEventListener("click", function (e) {
      var eyes = this.children[0];
      e.preventDefault();
...
(function ($) {
  $(document).ready(function () {
    $("[data-slider=authors]").owlCarousel({
      loop: true,
      nav: true,
      item: 4,
      margin: 45,
    ...
    $("[data-slider=typework]").owlCarousel({
      loop: true,
      nav: true,
      items: 4,
      margin: 30,
    ...
    $("[data-slider=typework2]").owlCarousel({
      loop: true,
      nav: true,
      items: 4,
      margin: 30,
    ...
    $("[data-slider=reviews]").owlCarousel({
      loop: true,
      nav: true,
      items: 4,
      margin: 45,
      dots: false,
      navText: ["<i class='prev-slide__white fal fa-angle-left'></i>", "<i class='next-slide__white fal fa-angle-right'></i>"],
      responsive: {
        0: {
          items: 1,
          nav: false,
    ...
    $("[data-slider=selectwork]").owlCarousel({
      loop: true,
      nav: true,
      items: 6,
      margin: 45,
    ...
    $("[data-slider=otherlang]").owlCarousel({
      loop: true,
      nav: false,
      items: 5,
      margin: 30,
    ...
    $('.paymentspage__tablink').click(function () {
      var tab_id = $(this).attr('data-tab');
      $('.paymentspage__tablink').removeClass('active');
      $('.paymentspage__content').removeClass('active');
      $(this).addClass('active');
      $("#" + tab_id).addClass('active');
    }); // text ellipsis

    function blogEllipsis() {
      var elem, size, text;
      var elem = document.getElementsByClassName("blog-card__desc-title");
    ...
    function serviseEllipsis() {
      var elem, size, text;
      var elem = document.getElementsByClassName("service-card__text");
      var text = elem.innerHTML;
      var size = 170;
      var n = 169;
    ...
    function blogPostEllipsis() {
      var elem, size, text;
      var elem = document.getElementsByClassName("post__text");
      var text = elem.innerHTML;
      var size = 400;
      var n = 399;
    ...
    $(".notfound__btnHide").click(function () {
      $(".notfound-img").css('transform', 'translateX(-400%)');
      $(".notfound-img").css('transition', 'all 1s');
      $(".notfound__btnHide").css('transform', 'translateX(-4000%)');
      $(".notfound__btnHide").css('outline', 'none');

      function func() {
        $(".notfound-img").css('transform', 'translateX(0%)');
        $(".notfound-img").css('transition', 'all 1s');
        $(".notfound__btnHide").css('transform', 'translateX(0%)');
      }

      setTimeout(func, 1000);
    }); // spoiler

    var spoiler = document.getElementsByClassName("collapsible__btn");
    var i;
    ...
    // review раскрыть список комментария || Главная


    var reviewBtnOpen = document.querySelectorAll(".review__open");
    var reviewBtnClose = document.querySelectorAll(".review__close");

    var _loop = function _loop(_i) {
      reviewBtnOpen[_i].addEventListener("click", function () {
        reviewBtnOpen[_i].parentNode.children[3].classList.toggle("expand");

        reviewBtnOpen[_i].parentNode.children[4].style.cssText = "display: none";
        reviewBtnOpen[_i].parentNode.children[5].style.cssText = "display: block";
      });
    };

    for (var _i = 0; _i < reviewBtnOpen.length; _i++) {
      _loop(_i);
    }

    var _loop2 = function _loop2(_i2) {
      reviewBtnClose[_i2].addEventListener("click", function () {
        reviewBtnClose[_i2].parentNode.children[3].classList.toggle("expand");

        reviewBtnClose[_i2].parentNode.children[4].style.cssText = "display: block";
        reviewBtnClose[_i2].parentNode.children[5].style.cssText = "display: none";
      });
    };

    for (var _i2 = 0; _i2 < reviewBtnClose.length; _i2++) {
      _loop2(_i2);
    } // btn menu overlay
    ...
    $(".nav-toggle").click(function () {
      ...
      $(".topline").toggleClass("topline__overlay");
      $(".navheader").toggleClass("navheader__overlay");
      $(".text-close").show();
    });
    $(".text-close, .topline-overlay").click(function () {
      $(".nav-toggle").toggleClass("close");
      $(".topline").toggleClass("topline__overlay");
      $(".navheader").toggleClass("navheader__overlay");
      $(".text-open").show();
      $(".dropdown__overlay").hide();
      $(this).hide();
    });
    $(".dropdown__btn").click(function () {
      $(this).show();
      $(".dropdown__content").toggleClass("open");
      $(".icon__down").toggleClass("open");
      $(".dropdown").toggleClass("dropdown__overlay");
    });
  }); // open mini block in price modal form

  $(".fieldset__addInfo").click(function () {
    $(".fieldset__addInfo").toggleClass("fieldset__addInfo-active");
    $(".fieldset__blockWrap").toggleClass("fieldset__blockWrap-active");
  }); // fixed input tel in modalForm
  // var width = window.innerWidth;
  // alert(width);
  // if (window.innerWidth > 480) {
  //   alert(window.innerWidth)

  $(".input__fixed").parent("div").css("margin", "0px");
  $(".input__fixed").parent("div").css("width", "275px");
  $(".mainform__btnBlock").click(function () {
    $(".mainform__circle").toggleClass("mainform__circle-active");
  }); //menu mobile burder in personal_page  

  $(".navToggle__open").click(function () {
    $(".leftMenuFixed").addClass("leftMenuFixed-active");
    $(".navToggle__open").hide();
    $(".navToggle__close").show();
  });
  $(".navToggle__close").click(function () {
    $(".leftMenuFixed").removeClass("leftMenuFixed-active");
    $(".navToggle__open").show();
    $(".navToggle__close").hide();
  }); // menu user in personal_page

  $(".person__userBlock").click(function () {
    $(".leftMenuFixed__pop").css("display", "block");
  });
  $(".person__bell").click(function () {
    $(".notific").css("display", "block");
  });
  $(".info__bank").click(function () {
    $(".info__person").removeClass("info__block-active");
    $(".info__bank").addClass("info__block-active");
    $(".vozvrat__block").css("display", "none");
    $(".vozvrat__bank").css("display", "block");
  });
  $(".info__person").click(function () {
    $(".info__bank").removeClass("info__block-active");
    $(".info__person").addClass("info__block-active");
    $(".vozvrat__bank").css("display", "none");
    $(".vozvrat__block").css("display", "block");
  });
})(jQuery); //checbox кол-ва страниц в модальном/index окне


$(document).ready(function () {
  var checkIndexObj = {
    mainformBtnForm: ".mainform__btnBlock-form-checkbox",
    inputForm: "mainform__numberPage-form",
    btnPlusForm: ".mainform__btn-form-plus",
    btnMinusForm: ".mainform__btn-form-minus"
  };

  if ($(".mainform__btnBlock-form-checkbox").length > 0) {
    var checkIndex = new Check(checkIndexObj);
  }

  var checkFormObj = {
    mainformBtnForm: ".mainform__btnBlock-checkbox",
    inputForm: "mainform__numberPage",
    btnPlusForm: ".mainform__btn-plus",
    btnMinusForm: ".mainform__btn-minus"
  };

  if ($(".mainform__btnBlock-checkbox").length > 0) {
    var checkForm = new Check(checkFormObj);
  }

  var checkPersonObj = {
    mainformBtnForm: ".mainform__btnBlock-personal-checkbox",
    inputForm: "mainform__numberPage-person",
    btnPlusForm: ".mainform__btn-person-plus",
    btnMinusForm: ".mainform__btn-person-minus"
  };

  if ($(".mainform__btnBlock-personal-checkbox").length > 0) {
    var checkPerson = new Check(checkPersonObj);
  }

  function Check(obj) {
    this.mainformBtnForm = document.querySelector(obj.mainformBtnForm);
    this.inputForm = document.getElementById(obj.inputForm);
    this.btnPlusForm = document.querySelector(obj.btnPlusForm);
    this.btnMinusForm = document.querySelector(obj.btnMinusForm);
    var check = this;
    this.mainformBtnForm.addEventListener("click", function () {
      console.log("click");

      if (check.mainformBtnForm.checked) {
        check.inputForm.disabled = true;
        check.btnPlusForm.disabled = true;
        check.btnMinusForm.disabled = true;
      } else {
        check.inputForm.disabled = false;
        check.btnPlusForm.disabled = false;
        check.btnMinusForm.disabled = false;
      }
    }); // size page in work modal/index Form

    this.btnPlusForm.addEventListener("click", function () {
      if (check.inputForm.value == 0) {
        check.inputForm.value = 11;
      } else {
        check.inputForm.value = +check.inputForm.value + 1;
      }
    });
    this.btnMinusForm.addEventListener("click", function () {
      if (check.inputForm.value == 0) {
        check.inputForm.value = 9;
      } else {
        if (check.inputForm.value >= 2) {
          check.inputForm.value = +check.inputForm.value - 1;
        }
      }
    });
...
$(window).scroll(function () {
  if ($(".leftMenuFixed").length == 0) {
    if ($(this).scrollTop() > 100) {
      $('nav.navheader')[0].style.cssText = "padding: 2px; transition: all 1s";
      $('.topline')[0].style.cssText = " box-shadow: 0px 4px 16px var(--shadow-color-gray);";
      $('.progress').show();
    } else {
      $('nav.navheader')[0].style.cssText = "padding: 13px 0; transition: all 1s";
      $('.topline')[0].style.cssText = " box-shadow: none;";
      $('.progress').hide();
    }
  }
}); //авто заполнение названия вида работ в модальное окно формы

$(function ($) {
  var navBtn = document.querySelector(".navheader__buttons_order");
  var select = document.getElementById("mainform__select"); // || Главная

  document.querySelectorAll(".typework__btn").forEach(function (el) {
    el.addEventListener("click", function () {
      toOrderModal(el.parentElement.firstElementChild.firstElementChild.innerHTML);
    });
  }); //авто заполнение названия вида работ в модальное окно формы || Услуг

  document.querySelectorAll(".service-card__buttons-order").forEach(function (el) {
    el.addEventListener("click", function () {
      toOrderModal(el.parentElement.parentElement.children[0].children[0].innerHTML);
    });
  }); //авто заполнение названия вида работ в модальное окно формы || Основной Услуги

  document.querySelectorAll(".service-card__label-btn").forEach(function (el) {
    el.addEventListener("click", function () {
      toOrderModal(el.parentElement.previousElementSibling.children[0].innerHTML);
    });
  });

  function toOrderModal(text) {
    var clickEvent = new Event('click'); //создаем событие

    navBtn.dispatchEvent(clickEvent);
    select.value = text;
  }
...
$(document).mouseup(function (e) {
  ...
  var block = $(".leftMenuFixed__pop"); // определяем элемент, к которому будем применять условия (можем указывать ID, класс либо любой другой идентификатор элемента)
...
$(document).mouseup(function (e) {
  // отслеживаем событие клика по веб-документу
  var block = $(".notific"); // определяем элемент, к которому будем применять условия (можем указывать ID, класс либо любой другой идентификатор элемента)
...
}); //переключение форм  регистрация/авторизация в модальном окне

$(function ($) {
  $(".form__btnRegister").click(function () {
    $(".form__login").css('display', 'none');
    $(".form__register").css('display', 'block');
  });
  $(".form__btnAuthorization").click(function () {
    $(".form__login").css('display', 'block');
    $(".form__register").css('display', 'none');
  });
  $(".form__remember").click(function () {
    $(".form__recovery").css('display', 'none');
    $(".form__login").css('display', 'block');
  });
  $(".form__forgetPass a").click(function () {
    $(".form__login").css('display', 'none');
    $(".form__recovery").css('display', 'block');
  });
}); //открытие модального окна - клик на кнопку "Заказать работу" || datapicker на форме

$(function ($) {
  $(".navheader__buttons_order").click(function () {
    var _$$datepicker;
    ...
    $("#datepicker").datepicker((_$$datepicker = {
      ...
      firstDay: 1,
      showOtherMonths: true
    }, _defineProperty(_$$datepicker, "minDate", 0), _defineProperty(_$$datepicker, "beforeShow", function beforeShow(input, inst) {
      setTimeout(function () {
        inst.dpDiv.css({
          top: datepickerInput.getBoundingClientRect().top + 50,
          right: datepickerInput.getBoundingClientRect().right + 30
        });
      }, 0);
    }), _$$datepicker));
  });
  $(".form__closeModalPrice").click(function () {
    $(".form__wrapper").removeClass("form__wrapper-open");
    $(".project").removeClass("project-active");
    $(".form__closeModalPrice").removeClass("form__closeModalPrice-open");
    $("body").css('overflow', 'scroll');
  });
}); //открытие модального окна - клик на кнопку "Войти"

$(function ($) {
  //open-close form__modalForm
  $(".navheader__buttons_enter").click(function () {
    $(".form__wrapper").addClass("form__wrapper-open");
    $(".form__closeModalForm").addClass("form__closeModalForm-open");
    $(".form").addClass("form-open");
    $("body").css('overflow', 'hidden');
    $(".overlays").addClass("overlays-active");
  });
  $(".form__closeModalForm").click(function () {
    $(".form__wrapper").removeClass("form__wrapper-open");
    $(".form__closeModalForm").removeClass("form__closeModalForm-open");
...
}); // фун-я personal-balance-oplata подсчет % оплаты || Запись значений в input hidden для передачи в php 

$(function ($) {
  document.querySelectorAll("button.sale").forEach(function (el, i) {
    el.addEventListener("click", function () {
      debugger;
  ...
  var typeWorkSumm = document.querySelectorAll(".typeWorkSumm");
  var btnSale = document.querySelectorAll('.sale');
  var footerSumma = document.querySelectorAll(".footer__summa");
  var typeWorkSumHidden = document.querySelectorAll(".typeWorkSumHidden");
  var procentHidden = document.querySelectorAll(".procentHidden");

  function fun(i) {
    if (btnSale[i].classList.contains('active')) {
      footerSumma[i].innerHTML = +typeWorkSumm[i].innerHTML / 4;
      procentHidden[i].value = 0;
    } else {
      footerSumma[i].innerHTML = typeWorkSumm[i].innerHTML;
      procentHidden[i].value = 2;
    }

    typeWorkSumHidden[i].value = footerSumma[i].innerHTML;
  }

  for (var _i3 = 0; _i3 < btnSale.length; _i3++) {
    fun(_i3);
  }
}); // disable кнопки отправить по неактивному checkbox

$(function ($) {
  var checbox = document.querySelector("#terms__zakaz");

  if (checbox !== null) {
    checbox.onclick = function () {
      if (!this.checked) {
        $("#mainform__btn_submit-form").attr("disabled", true);
      } else {
        $("#mainform__btn_submit-form").removeAttr("disabled");
        ;
      }
    };
  }

  var checbox2 = document.querySelector("#terms__box");

  if (checbox2 !== null) {
    checbox2.onclick = function () {
      if (!this.checked) {
        $("#freebook_btn-3").attr("disabled", true);
      } else {
        $("#freebook_btn-3").removeAttr("disabled");
        ;
      }
    };
  }

  var checbox3 = document.querySelector("#mainform__btn-checkbox");

  if (checbox3 !== null) {
    checbox3.onclick = function () {
      if (!this.checked) {
        $("#mainform__btn_submit").attr("disabled", true);
      } else {
        $("#mainform__btn_submit").removeAttr("disabled");
        ;
      }
    };
  }

  var checbox4 = document.querySelector("#authorform__input");

  if (checbox4 !== null) {
    checbox4.onclick = function () {
      console.log(1111);

      if (!this.checked) {
        $("#authorform_submit").attr("disabled", true);
      } else {
        $("#authorform_submit").removeAttr("disabled");
        ;
      }
    };
  }
...
}); // Форма об авторах - кнопка регистрации

$(function ($) {
  $("#authorform_submitmobile").click(function () {
    var navBtn = document.querySelector(".navheader__buttons_enter");
    var clickEvent = new Event('click'); //создаем событие

    navBtn.dispatchEvent(clickEvent);
  });
}); //прокрутка блока сообщений к первому/новому
// $(function ($){
//   var blockMessage = document.querySelector(".message");
//   var topMenuFixed = document.querySelector(".topMenuFixed").clientHeight;;
//   console.log(topMenuFixed)
//  if (blockMessage !== null) {
//     var formMessage = document.querySelector(".formMessage");
//     var clientHeight = document.documentElement.clientHeight;
//     var h = clientHeight - topMenuFixed - 100;
//     if (document.documentElement.clientWidth > 1400) {
//       formMessage.style.cssText = `height: ${h}px`;
//       blockMessage.style.cssText= `height: ${h - 80}px`;
//       blockMessage.scrollTop = blockMessage.scrollHeight;
//     } else {
//       formMessage.style.cssText = `height: ${h}px`;
//       blockMessage.style.cssText= `height: ${h - 60}px`;
//       blockMessage.scrollTop = blockMessage.scrollHeight;
//       }
//   }
// })
},{"jquery":"HlZQ","owl.carousel":"SoV9","intl-tel-input":"xy1I","../node_modules/intl-tel-input/build/js/utils.js":"B0gP","jquery-datepicker":"8hAk"}]},{},["4sWe"], null)